...
bobby = Contact.create(first_name:"Bobby", last_name:"King", email:"BobbyKing@gmail.com", twitter:"@BobbyKing", github:"KingBobby", linkedin:"KingBobby",phone:"1231231233", website:"")
...
jacob = Contact.create(first_name:"Jacob", last_name:"Shemkovitz", email:"JacobShemkovitz@gmail.com", twitter:"@JShem", github:"JShem", linkedin:"JShem",phone:"3456546645", website:"")
jaden = Contact.create(first_name:"Jaden", last_name:"Jadenslastname", email:"jadensemail@gmail.com", twitter:"@jaden", github:"JadenGit", linkedin:"Jaden",phone:"5553336666", website:"")
jenn = Contact.create(first_name:"Jenn", last_name:"Yien", email:"JennYien@gmail.com", twitter:"@JennYien", github:"JennYien", linkedin:"JennYien",phone:"3456599345", website:"")
josh = Contact.create(first_name:"Josh", last_name:"Bubis", email:"Josh@gmail.com", twitter:"@Josh", github:"JoshBubis", linkedin:"JoshBubis",phone:"3456542345", website:"")
...
joy = Contact.create(first_name:"Joy", last_name:"Morgan", email:"Joy@gmail.com", twitter:"@Joy", github:"JoyMorgan", linkedin:"JoyMorgan",phone:"5676543456", website:"")
kyle = Contact.create(first_name:"Kyle", last_name:"Lee", email:"Kyle@gmail.com", twitter:"@Kyle", github:"KyleLee", linkedin:"KyleLee",phone:"4958409384", website:"")
matt = Contact.create(first_name:"Matt", last_name:"Morriesy", email:"Matt@gmail.com", twitter:"@Matt", github:"MattM", linkedin:"MattM",phone:"8769872345", website:"")
meiji = Contact.create(first_name:"Meiji", last_name:"Chen", email:"Meji@gmail.com", twitter:"@Meiji", github:"MeijiC", linkedin:"MeijiC",phone:"45698872938", website:"")
mohamed = Contact.create(first_name:"Mohamed", last_name:"Elgendy", email:"MohamedElgendy@gmail.com", twitter:"@MohamedElgendy", github:"MohamedElgendy", linkedin:"MohamedElgendy",phone:"4888729283", website:"")
nick = Contact.create(first_name:"Nicholas", last_name:"Marshall", email:"Nick@gmail.com", twitter:"@nick", github:"NickN", linkedin:"NickN",phone:"4598729283", website:"")
pan = Contact.create(first_name:"Pan", last_name:"W", email:"Pan@gmail.com", twitter:"@pan", github:"PanW", linkedin:"PanW",phone:"9873476592", website:"")
pam = Contact.create(first_name:"Pamela", last_name:"Nevins", email:"PamNev@gmail.com", twitter:"@pamnev", github:"pamnev", linkedin:"pamnev",phone:"5343336666", website:"")
piere = Contact.create(first_name:"Pierre", last_name:"C", email:"Pierre@gmail.com", twitter:"@pierre", github:"PierreW", linkedin:"Pierre",phone:"4937561934", website:"")
steph = Contact.create(first_name:"Steph", last_name:"N", email:"Steph@gmail.com", twitter:"@Steph", github:"StephN", linkedin:"Steph",phone:"9843759187", website:"")
toti = Contact.create(first_name:"Toti", last_name:"F", email:"Toti@gmail.com", twitter:"@Toti", github:"TotiF", linkedin:"Toti",phone:"3948571938", website:"")
victoria = Contact.create(first_name:"Victoria", last_name:"D", email:"Victoria@gmail.com", twitter:"@Victoria", github:"VictoriaF", linkedin:"Victoria",phone:"9374759283", website:"")
yuka = Contact.create(first_name:"Yuka", last_name:"N", email:"Yuka@gmail.com", twitter:"@YukaNagai", github:"YukaF", linkedin:"Yuka",phone:"83948572837", website:"")
zoe = Contact.create(first_name:"Zoe", last_name:"Sachs", email:"zoesachs@gmail.com", twitter:"@Zoesachs", github:"Zoesachs", linkedin:"Zoesachs",phone:"7677708374", website:"")
oez = Contact.create(first_name:"oez", last_name:"Sachs", email:"oezsachs@gmail.com", twitter:"@Zoesachs", github:"Zoesachs", linkedin:"Zoesachs",phone:"7677708374", website:"")
auky = Contact.create(first_name:"auky", last_name:"Sachs", email:"aukysachs@gmail.com", twitter:"@Zoesachs", github:"Zoesachs", linkedin:"Zoesachs",phone:"7677708374", website:"")
itot = Contact.create(first_name:"itot", last_name:"Sachs", email:"itotsachs@gmail.com", twitter:"@Zoesachs", github:"Zoesachs", linkedin:"Zoesachs",phone:"7677708374", website:"")
hpets = Contact.create(first_name:"hpets", last_name:"Sachs", email:"hpetssachs@gmail.com", twitter:"@Zoesachs", github:"Zoesachs", linkedin:"Zoesachs",phone:"7677708374", website:"")
keven = Contact.create(first_name:"Keven", last_name:"Sachs", email:"kevensachs@gmail.com", twitter:"@Zoesachs", github:"Zoesachs", linkedin:"Zoesachs",phone:"7677708374", website:"")
thomas = Contact.create(first_name:"Thomas", last_name:"Sachs", email:"thomassachs@gmail.com", twitter:"@Zoesachs", github:"Zoesachs", linkedin:"Zoesachs",phone:"7677708374", website:"")
yolanda = Contact.create(first_name:"yolanda", last_name:"Sachs", email:"yolandasachs@gmail.com", twitter:"@Zoesachs", github:"Zoesachs", linkedin:"Zoesachs",phone:"7677708374", website:"")
mortaki = Contact.create(first_name:"mortaki", last_name:"Sachs", email:"mortakisachs@gmail.com", twitter:"@Zoesachs", github:"Zoesachs", linkedin:"Zoesachs",phone:"7677708374", website:"")
...
Student.create(contact: josh, cohort:pluto, username:"josh", password:"password", completed:false, employed:true, employer:"GOOGLE! That's right. Josh got a job at fuckin GOOGLE. Fuck yall", employed_as:nil, took_survey:true)
